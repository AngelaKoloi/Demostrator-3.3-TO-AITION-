...
exposure_data = read_exposure_data(
  filename = here("/Users/angelakoloi/Desktop/yfs metabolites/2007/data/MR analysis/glucoseRSIDnew.tsv"),
  sep = "\t",
  snp_col = "RSID",
  beta_col = "beta", 
...
exposure_data$exposure <- "glucose"
```
...
outcome_list
#save(outcome_list, file = here("/Users/angelakoloi/Desktop/yfs metabolites/2007/data/MR analysis/", "outcome_forMR.RData")) 
```
...
preprocessed_list
#save(preprocessed_list, file = here("/Users/angelakoloi/Desktop/yfs metabolites/2007/data/MR analysis/", "all_processed.RData"))
```
...
#save(main_results_mr, file = here("/Users/angelakoloi/Desktop/yfs metabolites/2007/data/MR analysis/Results", "MR_DEP-CVD_results.RData"))
```
...
colnames(mr_presso_table) <- c("Exposure", "N SNPs", "GlobalTest_RSS", "GlobalTest_pvalue", "OutlierCorrected_estimate", "OutlierCorrected_se", "OutlierCorrected_pvalue", "DistortionTest_Coefficient", "DistortionTest_pvalue")2
